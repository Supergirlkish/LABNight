...
void static OutCmd(uint8_t command)
	{
	(*((volatile uint32_t*)0x400053FC))= command;
	(*((volatile uint32_t*)0x40004300)) = 0; 
	SysTick_Wait(80/2); 
	(*((volatile uint32_t*)0x40004300)) = 0x80; 
	SysTick_Wait(40*80); 
	}
	
	void LCD_Init(void)
	{ 
		(*((volatile uint32_t *)0x400FE608)) |= 0x03; 
		while(((*((volatile uint32_t *)0x400FEA08))&0x03) != 0x03) {}; 
			(*((volatile uint32_t *)0x40005528)) &= ~0xFF; 
			(*((volatile uint32_t *)0x40004528)) &= ~0xC0; 
			(*((volatile uint32_t *)0x4000552C)) = 0x00000000; 
			(*((volatile uint32_t *)0x4000452C)) &= ~0xFF000000; 
			(*((volatile uint32_t *)0x40005400)) = 0xFF; 
			(*((volatile uint32_t *)0x40004400)) |= 0xC0;
			(*((volatile uint32_t *)0x40005420))= 0x00; 
			(*((volatile uint32_t *)0x40004420)) &= ~0xC0; 
			(*((volatile uint32_t *)0x4000551C)) = 0xFF; 
			(*((volatile uint32_t *)0x4000451C)) |= 0xC0;
			(*((volatile uint32_t *)0x40005508)) = 0xFF; 
			(*((volatile uint32_t *)0x40004508)) |=0xC0;
			SysTick_Init(); 
			(*((volatile uint32_t*)0x40004300)) = 0; 
			SysTick_Wait(15000*80); 
			OutCmd(0x30); 
			SysTick_Wait(5000*80); 
			OutCmd(0x30); 
			SysTick_Wait(160*80); 
			OutCmd(0x30); 
			SysTick_Wait(160*80); 
		...
		{
			(*((volatile uint32_t*)0x400053FC)) = letter;
			(*((volatile uint32_t*)0x40004300)) = 0x40; 
			SysTick_Wait(80/2); 
			(*((volatile uint32_t*)0x40004300))= 0x80+0x40; 
			SysTick_Wait(80/2); 
			(*((volatile uint32_t*)0x40004300))= 0x40; 
			SysTick_Wait(40*80); 
		}
